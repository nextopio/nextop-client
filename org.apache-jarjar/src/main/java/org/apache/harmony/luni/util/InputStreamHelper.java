...
/**
 * The class contains static {@link InputStream} utilities.
 */
public class InputStreamHelper {
    ...
    static class ExposedByteArrayInputStream extends ByteArrayInputStream {
        ...
        /**
         * @see ByteArrayInputStream(byte[], int, int)
         */
    ...
    /**
     * Reads all bytes from {@link ByteArrayInputStream} using its
     ...
     * given {@link ByteArrayInputStream}.
     * 
     * @param is

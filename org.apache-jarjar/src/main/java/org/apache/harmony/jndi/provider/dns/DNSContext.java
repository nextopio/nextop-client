...
public class DNSContext implements DirContext, Cloneable {
     ...
     * 
     * @see DirContext#modifyAttributes(String,
     *      int, Attributes)
     */
     ...
     * This method is not supported by the DNS provider.
     * 
     * @see DirContext#modifyAttributes(Name,
     *      int, Attributes)
     */
     ...
     * This method is not supported.
     * 
     * @see DirContext#createSubcontext(String,
     *      Attributes)
     */
     ...
     * This method is not supported.
     * 
     * @see DirContext#createSubcontext(Name,
     *      Attributes)
     */
     ...
     * @see Context#addToEnvironment(String,
     *      Object)
     */

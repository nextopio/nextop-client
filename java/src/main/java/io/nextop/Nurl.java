...
public final class Nurl {
    ...
    public static Nurl valueOf(String s) {
        ...
        return new Nurl(new Target(method, path), via);
    }



    public static Nurl create(Target target, Via via) {
        return new Nurl(target, via);
    }

    public static Nurl local(Target target) {
        return new Nurl(target, LOCAL);
    }
    ...
    private Nurl(Target target, Via via) {
        this.target = target;
        this.via = via;
    }
